...
#         if training:
    ...
    # @tf.function
    def predict(self, x, n_steps=25, teacher_forcing = False, batch_size=None, verbose=False, steps=None, callbacks=None, max_queue_size=10, workers=1, use_multiprocessing=False):
